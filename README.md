...
<div style="text-align:center;">
    <img src="https://github.com/aplatag/project_em_simulation_2D/blob/main/images/escenario_GPR.png" alt="GPR scenario" style="width: 50%; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
</div>
